...
class DenovoVariantTest(TestCase):
    ...
    def test___constructor___variant_correctly_built(self):
        ...
        denovo_variant = DenovoVariant(
            5, "AACC", "GT", ml_path_nodes_it_goes_through, long_deletion_threshold=3
        )
        ...
        self.assertEqual(
            ml_path_nodes_it_goes_through, denovo_variant.ml_path_nodes_it_goes_through
        )
    ...
    def test___set_ml_path_nodes_it_goes_through___ml_path_nodes_it_goes_through_is_None(
        self,
    ):
    ...
    def test___set_ml_path_nodes_it_goes_through___one_node_less_than_expected_in_path_error_out(
        self,
    ):
    ...
    def test___set_ml_path_nodes_it_goes_through___one_node_more_than_expected_in_path_error_out(
        self,
    ):
        dummy_node = MLPathNode(key=(0, 1), sequence="A")
        ml_path_nodes_it_goes_through = [
    ...
    def test___set_ml_path_nodes_it_goes_through___each_base_is_covered_by_one_node(
        self,
    ):
        dummy_node = MLPathNode(key=(0, 1), sequence="A")
    ...
    def test___set_ml_path_nodes_it_goes_through___strict_insertion___no_ml_path_nodes_going_through_it_error_out(
        self,
    ):
    ...
    def test___set_ml_path_nodes_it_goes_through___strict_insertion___two_ml_path_nodes_going_through_it_error_out(
        self,
    ):
        denovo_variant = DenovoVariant(5, "", "ACGT")
        dummy_node = MLPathNode(key=(0, 1), sequence="A")
    ...
    def test___get_mutated_sequence___ml_path_has_two_distinct_nodes___AssertionError_raised(
        self,
    ):
    ...
    def test___get_mutated_sequence___bad_start_index_before_node_start_AssertionError_raised(
        self,
    ):
    ...
    def test___get_mutated_sequence___bad_end_index_after_node_end_AssertionError_raised(
        self,
    ):
    ...
    def test___get_mutated_sequence___node_seq_not_consistent_with_ref_AssertionError_raised(
        self,
    ):
    ...
    def test___split_variant___ml_path_nodes_it_goes_through_is_None___raises_Assertion_Error(
        self,
    ):
        with self.assertRaises(AssertionError):
    ...
    def test___split_variant___deletion_var_goes_through_two_nodes_split_in_middle(
        self,
    ):
        ...
        expected = [
            DenovoVariant(5, "AC", "C", [dummy_node_1, dummy_node_1]),
    ...
    def test___split_variant___deletion_variant_goes_through_two_nodes_split_in_middle_with_mismatch(
        self,
    ):
        ...
        expected = [
            DenovoVariant(5, "ACG", "CA", [dummy_node_1, dummy_node_1, dummy_node_1]),
    ...
    def test___split_variant___deletion_var_goes_through_two_nodes_split_in_start(self):
        ...
        expected = [
            DenovoVariant(5, "AC", "GC", [dummy_node_1, dummy_node_1]),
            DenovoVariant(7, "GT", "G", [dummy_node_2, dummy_node_2]),
        ]
        actual = denovo_variant.split_variant()
    ...
    def test___split_variant___deletion_var_goes_through_two_nodes_split_in_start___one_variant_removed(
        self,
    ):
    ...
    def test___split_variant___deletion_var_goes_through_two_nodes_split_in_end___long_deletion_threshold_removes_one(
        self,
    ):
        denovo_variant = DenovoVariant(5, "ACGT", "CCT")
        dummy_node_1 = MLPathNode(key=(0, 1), sequence="A")
    ...
    def test___split_variant___deletion_var_goes_through_two_nodes_split_in_end___one_variant_removed(
        self,
    ):
    ...
    def test___split_variant___phased_snps_var_goes_through_two_nodes_split_in_middle(
        self,
    ):
        ...
        expected = [
            DenovoVariant(5, "AG", "TG", [dummy_node_1, dummy_node_1]),
    ...
    def test___split_variant___phased_snps_var_goes_through_two_nodes_split_in_start(
        self,
    ):
        ...
        expected = [
            DenovoVariant(5, "A", "T", [dummy_node_1]),
    ...
    def test___split_variant___phased_snps_var_goes_through_two_nodes_split_in_end(
        self,
    ):
        ...
        expected = [
            DenovoVariant(5, "ACG", "AGG", [dummy_node_1, dummy_node_1, dummy_node_1]),
    ...
    def test___split_variant___insertion_var_goes_through_two_nodes_split_in_middle(
        self,
    ):
        ...
        expected = [
            DenovoVariant(5, "G", "TG", [dummy_node_1]),
    ...
    def test___split_variant___insertion_var_goes_through_two_nodes_split_in_start___one_variant_removed(
        self,
    ):
    ...
    def test___split_variant___insertion_var_goes_through_two_nodes_split_in_end___one_variant_removed(
        self,
    ):
    ...
    def test___split_variant___long_insertion_var_before_and_after_goes_through_two_nodes(
        self,
    ):
        ...
        expected = [
            DenovoVariant(5, "T", "AAAAT", [dummy_node_1]),
    ...
    def test___split_variant___long_insertion_var_before_after_and_between_goes_through_two_nodes(
        self,
    ):
    ...
    def test___split_variant___del_snp_ins_goes_through_three_nodes(self):
        ...
        expected = [
            DenovoVariant(5, "AAAAAA", "AA", [dummy_node_1] * 6),
    ...
    def test___split_variant___dels_through_several_nodes(self):
        ...
        expected = [
            DenovoVariant(6, "C", "", [dummy_node_2]),
    ...
    def test___split_variant___middle_ml_path_node_is_removed(self):
        ...
        expected = [
            DenovoVariant(156, "T", "CT", [dummy_node_1]),
